  ...
  return (
    <>
      ...
      <div className="flex-col justify-start pl-5 w-[90%]">
        <h3
          className={`${asap.className} mb-2 text-gray-500 mt-6 font-semibold`}
        >
          Additional charges
        </h3>
        <p>Complimentary on-site parking</p>
        <p>Changes in taxes and fees will aff affect the total room price</p>
      </div>
      ...
      <h3
        className={`${asap.className} flex justify-center mb-4 text-gray-500 mt-6 font-semibold`}
      >
        Book now!
      </h3>
      <div className="flex justify-center">
      ...
      <div className="mt-8">
        <h3
          className={`${asap.className} font-semibold text-gray-500 mb-2 pl-5`}
        >
          Modifying
        </h3>
        <p className="text-center">
          Any change in the length or dates of a reservation may result in a
          rate change
        </p>
      </div>
      <div className="flex justify-center">
      ...
      <div className="flex flex-col w-[80%]  pl-5">
        ...
        <p>
          You may cancel your reservation for no charge, before 3 days' arrival.
          Please note that we will assess a fee of 810 USD if you must cancel
          after this deadline.
        </p>
      </div>
    </>
