...
import {  deleteUsersReal, fetchingUsersReal, activeUsersReal, getallUsersReal } from '../../../redux/Features/UsersReal/usersRealSlice';
import { useDispatch } from 'react-redux';
import SelectUniversal from '../../SelectUniversal/SelectUniversal';



const UsersDeleted = (props) => {
		...
		<div className=' relative mt-5 mb-5'>
			...
			<form className='relative w-full p-4 pt-7 pb-7 rounded-2xl bg-white shadow-buttonAdd '>
				...
				<div className='flex justify-between items-center mt-2 mb-2 h-10'>
					...
					<SelectUniversal optionDefault={Rol} data={userDataEdit} deleted={"deleted"} />
				...
				<div className='flex flex-col'>
					<div className='flex items-center mt-2 mb-2 h-10'>
						...
						<label
							...
							className=' font-medium text-zinc-600 w-2/5 text-sm'
						>
							Delete User
						</label>
						<button
