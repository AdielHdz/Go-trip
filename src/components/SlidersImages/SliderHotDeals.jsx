    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "/hotel/findhotel/?destinationId=5ce1ce9c-ceda-4666-8c72-0f4ec34a21fe",
          {
            headers: {
                ...
                <div className="h-56 relative">
                  <div className="absolute bottom-0 text-white w-full pl-3 pr-3 h-12 ">
                    ...
                    <div className="flex justify-between">
                      <h2
                        className={`${roboto.className} relative z-10 flex justify-center items-center`}
                      >
                        {hotel.name}
                      </h2>
                      <h2
                        className={`${roboto.className} text-little relative text-base z-50 flex justify-center items-center`}
                      >
                        $250
                      </h2>
                    </div>
                    <div className="flex justify-between">
                      <p
                        className={`text-little relative z-10 flex justify-center items-center `}
                      >
                        {hotel.city}
                      </p>

                      <p className="text-little relative z-10 flex justify-center items-center">
                        per night
                      </p>
                    </div>
                  </div>
